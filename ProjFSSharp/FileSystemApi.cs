...
public sealed class FileSystemApi
{
    ...
    //TODO: Switch out to managed API as described here: http://pinvoke.net/default.aspx/shlwapi.PathRelativePathTo
    ...
    public static bool TryGetReparsePointTarget(string source,
        [NotNullWhen(true)]
        out string? target)
    {
        target = null;
    ...
    public static string TryGetPathRelativeToRoot(string root, string path, bool isPathToADirectory)
    {
        ...
        StringBuilder relativePathBuilder = new(MaxPath);
